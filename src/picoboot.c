...
const uint PIN_DATA_BASE = 26;           // Base pin used for output, 4 consecutive pins are used 
const uint PIN_CS = 1;                 // U10 chip select
const uint PIN_CLK = 2;                // EXI bus clock line
